// Step 5 — Same loop, harder task. Multi-step plan: add three, complete one, list.
...
runAgent(
  "Add groceries, milk, and eggs to my list. Then mark milk as done. Then show me the final list."
);
